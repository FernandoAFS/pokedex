...
export const PokemonCard = ({ name, imageSrc, tags, imageAlt, generation, className}: PokemonCardProps) => (
    // Source: https://v1.tailwindcss.com/components/cards
    //
    <div className={`max-w-sm rounded overflow-hidden shadow-lg ${className}`}>
        <Image className="w-full" src={imageSrc} alt={imageAlt} height={500} width={500}/>
