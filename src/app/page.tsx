...
async function Home({
  ...
  const {search, types: typesJson, generations: generationsJson, page: pageParam} = params
  ...
  const allPokemon = await getAllPokemon({ 
    ...
    ...(generationFilter && {generationFilter: generationFilter as PokemonGeneration[]}),
  })
  ...
  return (
    <>
      ...
      {allPokemon.slice(0, ITEMS_PER_PAGE).map(({ pokemonId, name, type1, type2, generation}) => (
